...
export const MessageList = memo(function MessageList({
  ...
  // Force scroll to the latest message whenever a new message is appended.
  // This keeps the newest assistant placeholder in view instead of leaving the
  // previous response pinned near the bottom of the viewport.
  useEffect(() => {
    ...
    <>
      ...
      {showScrollButton && (
        <button
          ...
          className="scroll-button fixed bottom-32 right-4 sm:right-8 p-3 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-transform z-50 border border-border/60"
          style={{
            background: '#5FB58A',
            color: 'white',
          }}
